        ...
        <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl w-full max-w-md p-8 rounded-[2.5rem] shadow-2xl z-10 text-center border border-white/20 dark:border-slate-800">
          ...
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24">
              <path fill="#EA4335" d="M12 5.04c1.94 0 3.51.68 4.75 1.83l3.48-3.48C18.13 1.42 15.31 0 12 0 7.31 0 3.25 2.68 1.21 6.6L4.82 9.39C5.7 6.84 8.09 5.04 12 5.04z" />
              <path fill="#4285F4" d="M23.49 12.27c0-.85-.07-1.68-.22-2.48H12v4.69h6.48c-.28 1.48-1.11 2.73-2.38 3.58l3.69 2.87c2.16-1.99 3.4-4.92 3.4-8.66z" />
              <path fill="#FBBC05" d="M4.82 14.61c-.24-.71-.38-1.48-.38-2.27s.14-1.56.38-2.27L1.21 6.6C.44 8.19 0 10.01 0 12s.44 3.81 1.21 5.4l3.61-2.79z" />
              <path fill="#34A853" d="M12 24c3.24 0 5.97-1.07 7.96-2.91l-3.69-2.87c-1.08.73-2.46 1.17-4.27 1.17-3.91 0-7.23-2.63-8.41-6.18L1.21 15.93C3.25 21.32 7.31 24 12 24z" />
            </svg>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div className="p-4 border-t dark:border-slate-800 text-center bg-slate-50 dark:bg-slate-900/50">
              <button onClick={() => setShowCategoryManager(false)} className="px-10 py-2.5 bg-indigo-600 text-white rounded-xl font-bold shadow-lg shadow-indigo-500/20 active:scale-95 transition-all">Close Settings</button>
            </div>
          </div>
        </div>
      )}
